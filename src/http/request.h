...
//HttpRequest *http_request_add_query_param(HttpRequest *request, const char *key, const char *value);
//HttpRequest *http_request_set_timeout(HttpRequest *request, long seconds);
//HttpRequest *http_request_set_bearer_token(HttpRequest *request, const char *token);
//HttpRequest *http_request_follow_redirects(HttpRequest *request, int follow, int max);
